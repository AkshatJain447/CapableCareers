    ...
    return (
      <div className=" lg:w-4/5 p-6 md:px-10 border shadow-xl m-4 lg:mx-10 rounded-xl">
        ...
        <div className="flex mt-2 md:mt-auto md:justify-end">
          <button className=" border p-2 hover:scale-105 hover:border-secondary hover:text-secondary duration-200 shadow-sm hover:shadow-md font-semibold bg-gray-200 text-gray-800 hover:bg-white rounded-md cursor-pointer">
            Edit Personal Info
          </button>
        </div>
      </div>
